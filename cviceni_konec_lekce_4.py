...
# fce split - rozděluje string podle mezer (pokud je závorka ve fci split() prázdná)
vycistena_slova = [] # nastavuji prázdný list

for slovo in TEXT.split(): # budu iterovat list rozsekaných slov, split tvoří list!
